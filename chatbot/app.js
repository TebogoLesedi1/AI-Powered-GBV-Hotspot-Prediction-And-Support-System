...
languageSelect.addEventListener('change', () => { if (languageSelect.value !== 'en-ZA') document.querySelector('#record-count').textContent = safetyPhrases[languageSelect.value]; });
loadReport();